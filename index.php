...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                        ...
                        <li class="nav-item"><a class="nav-link link text-black display-4"
                                href="filters.html" target="_blank">Filters</a>
                        </li>
                    </ul>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <div class="image-wrapper">
                        <img src="assets/images/photography-801891-1920-1076x717.jpg" alt="Mobirise">
                    </div>
                </div>
                <div class="col-12 col-md">
                    <div class="text-wrapper">
                        <p class="mbr-text mbr-fonts-style mb-4 display-7">“Photography is a way of feeling, of
                        ...
                        <p class="name mbr-fonts-style mb-1 display-4"><strong>Aaron Siskind</strong></p>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="content7 cid-ssp6j0FcSc" id="content7-b">
    ...
    <section class="gallery1 cid-srZMqP1bME" id="gallery1-a">
            ...
            <div class="row mt-4">
                ...
                <div class="item features-image сol-12 col-md-6 col-lg-6">
                    <div class="item-wrapper">
                        <div class="item-img">
                            <img src="assets/images/dsc-0475-2-1108x739.jpg" alt="" title="" data-slide-to="3">
                        </div>
                    </div>
                </div>
                <div class="item features-image сol-12 col-md-6 col-lg-6">
                    <div class="item-wrapper">
                        <div class="item-img">
                            <img src="assets/images/whatsapp-image-2021-03-18-at-15.23.47-1080x720.jpg" alt=""
                                data-slide-to="0">
                        </div>
                    </div>
                </div>
                <div class="item features-image сol-12 col-md-6 col-lg-6">
                    <div class="item-wrapper">
                        <div class="item-img">
                            <img src="assets/images/dsc-303-2048x1366.jpg" alt="" data-slide-to="0">
                        </div>
                    </div>
                </div>
                <div class="item features-image сol-12 col-md-6 col-lg-6">
                    <div class="item-wrapper">
                        <div class="item-img">
                            <img src="assets/images/dsc-232-2048x1366.jpg" alt="" data-slide-to="0">
                        </div>
    ...
    <section class="contacts4 cid-spajBnt0w5" id="contacts4-5">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="text-content col-12 col-md-6">
                    ...
                    <p class="mbr-text mbr-fonts-style display-7">Follow us on different channels and in particular tag
                        us in Instagram with our tag #passion_4_pics. Every week we repost the best pics in our gallery.
                    </p>
                </div>
                <div class="icons d-flex align-items-center col-12 col-md-6 justify-content-end mt-md-0 mt-2 flex-wrap">
                    ...
                    <a href="https://www.instagram.com/_passion4pics/" target="_blank">
