...
<div id="container-presets" style="margin-top:3%" class="container-fluid">
			...
			<ul>
				...
				<li>
					...
					<p>
						...
						AUTHOR: Chris Bray
						LINK: <a href="https://www.udemy.com/course/free-photography-course-for-beginners/#overview" target="_blank">Click here to see</a>
					</p>
				</li>
				<li>
				<h4>Photoshop Fundamentals</h4>
					<p>
						...
						AUTHOR: Hardy Fowler
						LINK: <a href="https://www.udemy.com/course/photoshop-fundamentals-in-one-hour/" target="_blank">Click here to see</a>
					</p>
				</li>
				<li>
				<h4>Lightroom 5 Photographer Workflow</h4>
						...
						AUTHOR: Jerad Hill
						LINK: <a href="https://www.udemy.com/course/lightroom-5-photographer-workflow/" target="_blank">Click here to see</a>
